...
<section id="projects-page">
    ...
    @foreach($projects as $proj)
      <div class="modal fade" id="exampleModalCenter{{$proj->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="width: 850px;">
              ...
              <div class="wrap-modal-slider" style="padding-left: 0px;padding-right: 0px;">
                <div class="your-class">
                  @foreach(json_decode($proj->images) as $prject_img)
                    <div>
                      <div class="" style="background-image: url('{{file_manager_get_url($prject_img)}}');height: 600px;background-size: cover; background-repeat: no-repeat; height: 500px;"></div>
                    </div>
                  @endforeach
                </div>
